...
export default async function profilePage(parts = []) {
  const targetId = parts[0] // آیدی کاربر مورد بازدید (اگه خالی باشه یعنی پروفایل خودم)
  ...
  return withShell('profile', async (myProfile) => {
    ...
    // گرفتن تعداد فالوورها و فالووینگ‌ها
    ...
    const isPending = followStatus?.data?.status === 'pending'

    // گرفتن پست‌های این کاربر
        ...
        <header class="profile-header">
          ...
          <div class="profile-details">
            ...
            <div class="profile-stats">
              ...
              <span><b>${followingCount?.length || 0}</b> following</span>
            </div>
    ...
    return {
      ...
      mount: (app) => {
        ...
        // کلیک روی پست‌های گرید برای رفتن به صفحه هوم (فید) روی آن پست خاص
